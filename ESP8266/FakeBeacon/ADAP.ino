...
void RickRoll() {
    sendBeacon("01 MOPCON 2019 廣告時間");
    sendBeacon("02 如果 10/19 下午第一場");
    sendBeacon("03 不知道應該聽什麼");
    sendBeacon("04 請到 R3 報到");
    sendBeacon("05 Hoyo 分享 IoT 主題");
    sendBeacon("06 米家就是我家");
    sendBeacon("07 自己 DIY 完整 IoT 生態");
    sendBeacon("08 歡迎大家一起來玩");
}
